...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	"195_channel_monitor_mode.sql": newMigrationChecksumCompatibilityRule("73c39ac374c722253135041466108836845828a6065b499c60e7f27d6b92c21c", "13f3792f3e3e53ee96e26415c884cf8062c77172824b54fcc9a8c0c2b1f185ec", "4c74fe33ef2274cc72e1bb49671e651274532c034b29f5b2982c2a4c88d101a6"),
	...
	"220_clear_non_grok_video_generation_config.sql": newMigrationChecksumCompatibilityRule("cf4dbfa75ac27d93a30a6a14439fe7dccfc911c043358363d5ec47946aa0e28b", "85e320b9ec64f2d3fcd8cf705b2b4e76a7b49f7a57140c14bff97f32691c818b", "3da48c8fdffe6390325f43d08b8e353e0a365df43d44a78dbbe655d0deb18402"),
	"219_group_search_price_per_1k.sql":              newMigrationChecksumCompatibilityRule("430c2e3595342fe22c59e9676e9b18ea376f076324b77174a21e6f181f57f4b5", "e86786ebcc3b14206fd2d321380a4e50e80cdadbfcf4962c639255e6a14008db", "df6ffd71b97e30ec2c8fe7b95e15783042dea58c553e32701ee7c42a5619af80"),
	"218_group_audio_voice_pricing.sql":              newMigrationChecksumCompatibilityRule("a99ade7d0d464c67bf56814570050cc363ffad64eae2cb1e1ed760065f0b3585", "40ee9f3a2af0e0a5e99dabc878fd0fe98be1011f26bcfcefcac7197f7081f0e7", "c2a5e5b4ffd6968ad1c10593289fbc11192cdea19fec3ed9bce3a84eff9a8351"),
}
...
func applyMigrationsFS(ctx context.Context, db *sql.DB, fsys fs.FS) error {
	...
	for _, name := range files {
		...
		content := normalizeMigrationContent(string(contentBytes))
		if content == "" {
			continue // 跳过空文件
		}
