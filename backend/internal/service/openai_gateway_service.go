...
const openAIForwardClientDisconnectContextKey = "openai_forward_client_disconnect"

func markOpenAIForwardClientDisconnect(c *gin.Context) {
	if c != nil {
		c.Set(openAIForwardClientDisconnectContextKey, true)
	}
}

func openAIForwardClientDisconnected(c *gin.Context) bool {
	if c == nil {
		return false
	}
	value, ok := c.Get(openAIForwardClientDisconnectContextKey)
	disconnected, _ := value.(bool)
...
type OpenAIGatewayService struct {
	...
	accountRuntimePolicy  AccountRuntimePolicyStore
