...
// ExternalUsageLogFilters defines filters for the legacy external usage export API.
...
// ExternalUsageLog is the legacy denormalized usage row returned to external systems.
...
// ExternalUsageLogTotals summarizes the rows matching an external usage export query.
