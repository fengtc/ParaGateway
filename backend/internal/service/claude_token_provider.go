...
func (p *ClaudeTokenProvider) SetWIFTokenProvider(provider *WIFTokenProvider) {
	if p != nil {
...
func (p *ClaudeTokenProvider) GetAccessToken(ctx context.Context, account *Account) (string, error) {
	...
	if account.Platform == PlatformAnthropic && account.Type == AccountTypeAPIKey && account.IsWIF() {
