...
func TestBatchImageSettlementService_SettlesAndChargesSuccessfulImagesOnly(t *testing.T) {
	...
	job.WorkAttribution = &UsageWorkAttribution{
	...
	require.NotNil(t, usageLogs.lastLog.WorkAttribution)
	require.Equal(t, "paragateway", usageLogs.lastLog.WorkAttribution.ProjectRef)
	require.Equal(t, WorkCategoryCoding, usageLogs.lastLog.WorkAttribution.Category)
