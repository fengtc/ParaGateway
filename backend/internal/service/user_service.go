...
type UserListFilters struct {
	...
	// EmailExact performs a normalized (trimmed, case-insensitive) email
	// equality lookup. It is intentionally separate from Search so callers
	// that resolve an identity do not accidentally select a fuzzy match.
	EmailExact string
