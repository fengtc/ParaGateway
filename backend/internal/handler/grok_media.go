	...
	for {
		...
		if err != nil {
			...
			if errors.As(err, &failoverErr) {
				...
				h.gatewayService.ReportOpenAIAccountSelectionOutcome(selection, grokMediaScheduleModel(account, routingModel, nil), service.AccountRuntimeOutcomeFromContext(c.Request.Context(), failoverErr), nil)
			...
			h.gatewayService.ReportOpenAIAccountSelectionOutcome(selection, grokMediaScheduleModel(account, routingModel, nil), service.AccountRuntimeOutcomeFromContext(c.Request.Context(), err), nil)
		...
		h.gatewayService.ReportOpenAIAccountSelectionOutcome(selection, grokMediaScheduleModel(account, routingModel, result), service.AccountRuntimeOutcomeFromOpenAIForwardContext(c.Request.Context(), result, nil), nil)
