...
func (h *OpenAIGatewayHandler) ChatCompletions(c *gin.Context) {
	...
	for {
		...
		h.gatewayService.ReportOpenAIAccountSelectionOutcome(selection, account.GetMappedModel(reqModel), service.AccountRuntimeOutcomeFromOpenAIForwardContext(c.Request.Context(), result, err), firstTokenMs)
