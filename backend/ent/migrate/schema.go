...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "circuit_breaker_threshold", Type: field.TypeInt, Default: 0},
		{Name: "circuit_breaker_cooldown_seconds", Type: field.TypeInt, Default: 0},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "github_copilot_only", Type: field.TypeBool, Default: false},
