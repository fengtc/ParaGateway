...
type Account struct {
	...
	// CircuitBreakerThreshold holds the value of the "circuit_breaker_threshold" field.
	CircuitBreakerThreshold int `json:"circuit_breaker_threshold,omitempty"`
	// CircuitBreakerCooldownSeconds holds the value of the "circuit_breaker_cooldown_seconds" field.
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldID, account.FieldProxyID, account.FieldProxyFallbackOriginID, account.FieldConcurrency, account.FieldLoadFactor, account.FieldPriority, account.FieldWeight, account.FieldRpmLimit, account.FieldCircuitBreakerThreshold, account.FieldCircuitBreakerCooldownSeconds, account.FieldParentAccountID:
...
func (_m *Account) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case account.FieldCircuitBreakerThreshold:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field circuit_breaker_threshold", values[i])
			} else if value.Valid {
				_m.CircuitBreakerThreshold = int(value.Int64)
			}
		case account.FieldCircuitBreakerCooldownSeconds:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field circuit_breaker_cooldown_seconds", values[i])
			} else if value.Valid {
				_m.CircuitBreakerCooldownSeconds = int(value.Int64)
			}
		case account.FieldRateMultiplier:
...
func (_m *Account) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("circuit_breaker_threshold=")
	builder.WriteString(fmt.Sprintf("%v", _m.CircuitBreakerThreshold))
	builder.WriteString(", ")
	builder.WriteString("circuit_breaker_cooldown_seconds=")
	builder.WriteString(fmt.Sprintf("%v", _m.CircuitBreakerCooldownSeconds))
	builder.WriteString(", ")
