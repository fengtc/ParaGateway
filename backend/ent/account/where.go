...
// CircuitBreakerThreshold applies equality check predicate on the "circuit_breaker_threshold" field. It's identical to CircuitBreakerThresholdEQ.
func CircuitBreakerThreshold(v int) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldCircuitBreakerThreshold, v))
}

// CircuitBreakerCooldownSeconds applies equality check predicate on the "circuit_breaker_cooldown_seconds" field. It's identical to CircuitBreakerCooldownSecondsEQ.
func CircuitBreakerCooldownSeconds(v int) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldCircuitBreakerCooldownSeconds, v))
}
...
// CircuitBreakerThresholdEQ applies the EQ predicate on the "circuit_breaker_threshold" field.
func CircuitBreakerThresholdEQ(v int) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldCircuitBreakerThreshold, v))
}

// CircuitBreakerThresholdNEQ applies the NEQ predicate on the "circuit_breaker_threshold" field.
func CircuitBreakerThresholdNEQ(v int) predicate.Account {
	return predicate.Account(sql.FieldNEQ(FieldCircuitBreakerThreshold, v))
}

// CircuitBreakerThresholdIn applies the In predicate on the "circuit_breaker_threshold" field.
func CircuitBreakerThresholdIn(vs ...int) predicate.Account {
	return predicate.Account(sql.FieldIn(FieldCircuitBreakerThreshold, vs...))
}

// CircuitBreakerThresholdNotIn applies the NotIn predicate on the "circuit_breaker_threshold" field.
func CircuitBreakerThresholdNotIn(vs ...int) predicate.Account {
	return predicate.Account(sql.FieldNotIn(FieldCircuitBreakerThreshold, vs...))
}

// CircuitBreakerThresholdGT applies the GT predicate on the "circuit_breaker_threshold" field.
func CircuitBreakerThresholdGT(v int) predicate.Account {
	return predicate.Account(sql.FieldGT(FieldCircuitBreakerThreshold, v))
}

// CircuitBreakerThresholdGTE applies the GTE predicate on the "circuit_breaker_threshold" field.
func CircuitBreakerThresholdGTE(v int) predicate.Account {
	return predicate.Account(sql.FieldGTE(FieldCircuitBreakerThreshold, v))
}

// CircuitBreakerThresholdLT applies the LT predicate on the "circuit_breaker_threshold" field.
func CircuitBreakerThresholdLT(v int) predicate.Account {
	return predicate.Account(sql.FieldLT(FieldCircuitBreakerThreshold, v))
}

// CircuitBreakerThresholdLTE applies the LTE predicate on the "circuit_breaker_threshold" field.
func CircuitBreakerThresholdLTE(v int) predicate.Account {
	return predicate.Account(sql.FieldLTE(FieldCircuitBreakerThreshold, v))
}

// CircuitBreakerCooldownSecondsEQ applies the EQ predicate on the "circuit_breaker_cooldown_seconds" field.
func CircuitBreakerCooldownSecondsEQ(v int) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldCircuitBreakerCooldownSeconds, v))
}

// CircuitBreakerCooldownSecondsNEQ applies the NEQ predicate on the "circuit_breaker_cooldown_seconds" field.
func CircuitBreakerCooldownSecondsNEQ(v int) predicate.Account {
	return predicate.Account(sql.FieldNEQ(FieldCircuitBreakerCooldownSeconds, v))
}

// CircuitBreakerCooldownSecondsIn applies the In predicate on the "circuit_breaker_cooldown_seconds" field.
func CircuitBreakerCooldownSecondsIn(vs ...int) predicate.Account {
	return predicate.Account(sql.FieldIn(FieldCircuitBreakerCooldownSeconds, vs...))
}

// CircuitBreakerCooldownSecondsNotIn applies the NotIn predicate on the "circuit_breaker_cooldown_seconds" field.
func CircuitBreakerCooldownSecondsNotIn(vs ...int) predicate.Account {
	return predicate.Account(sql.FieldNotIn(FieldCircuitBreakerCooldownSeconds, vs...))
}

// CircuitBreakerCooldownSecondsGT applies the GT predicate on the "circuit_breaker_cooldown_seconds" field.
func CircuitBreakerCooldownSecondsGT(v int) predicate.Account {
	return predicate.Account(sql.FieldGT(FieldCircuitBreakerCooldownSeconds, v))
}

// CircuitBreakerCooldownSecondsGTE applies the GTE predicate on the "circuit_breaker_cooldown_seconds" field.
func CircuitBreakerCooldownSecondsGTE(v int) predicate.Account {
	return predicate.Account(sql.FieldGTE(FieldCircuitBreakerCooldownSeconds, v))
}

// CircuitBreakerCooldownSecondsLT applies the LT predicate on the "circuit_breaker_cooldown_seconds" field.
func CircuitBreakerCooldownSecondsLT(v int) predicate.Account {
	return predicate.Account(sql.FieldLT(FieldCircuitBreakerCooldownSeconds, v))
}

// CircuitBreakerCooldownSecondsLTE applies the LTE predicate on the "circuit_breaker_cooldown_seconds" field.
func CircuitBreakerCooldownSecondsLTE(v int) predicate.Account {
	return predicate.Account(sql.FieldLTE(FieldCircuitBreakerCooldownSeconds, v))
}
