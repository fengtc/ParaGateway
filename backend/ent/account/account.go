...
const (
	...
	// FieldCircuitBreakerThreshold holds the string denoting the circuit_breaker_threshold field in the database.
	FieldCircuitBreakerThreshold = "circuit_breaker_threshold"
	// FieldCircuitBreakerCooldownSeconds holds the string denoting the circuit_breaker_cooldown_seconds field in the database.
	FieldCircuitBreakerCooldownSeconds = "circuit_breaker_cooldown_seconds"
...
var Columns = []string{
	...
	FieldWeight,
	FieldRpmLimit,
	FieldCircuitBreakerThreshold,
	FieldCircuitBreakerCooldownSeconds,
	FieldRateMultiplier,
	FieldStatus,
	FieldErrorMessage,
	FieldLastUsedAt,
...
var (
	...
	// DefaultCircuitBreakerThreshold holds the default value on creation for the "circuit_breaker_threshold" field.
	DefaultCircuitBreakerThreshold int
	// CircuitBreakerThresholdValidator is a validator for the "circuit_breaker_threshold" field. It is called by the builders before save.
	CircuitBreakerThresholdValidator func(int) error
	// DefaultCircuitBreakerCooldownSeconds holds the default value on creation for the "circuit_breaker_cooldown_seconds" field.
	DefaultCircuitBreakerCooldownSeconds int
	// CircuitBreakerCooldownSecondsValidator is a validator for the "circuit_breaker_cooldown_seconds" field. It is called by the builders before save.
	CircuitBreakerCooldownSecondsValidator func(int) error
...
// ByCircuitBreakerThreshold orders the results by the circuit_breaker_threshold field.
func ByCircuitBreakerThreshold(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldCircuitBreakerThreshold, opts...).ToFunc()
}

// ByCircuitBreakerCooldownSeconds orders the results by the circuit_breaker_cooldown_seconds field.
func ByCircuitBreakerCooldownSeconds(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldCircuitBreakerCooldownSeconds, opts...).ToFunc()
}
