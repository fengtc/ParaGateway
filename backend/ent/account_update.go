...
func (_u *AccountUpdate) SetCircuitBreakerThreshold(v int) *AccountUpdate {
	_u.mutation.ResetCircuitBreakerThreshold()
	_u.mutation.SetCircuitBreakerThreshold(v)
	return _u
}

// SetNillableCircuitBreakerThreshold sets the "circuit_breaker_threshold" field if the given value is not nil.
func (_u *AccountUpdate) SetNillableCircuitBreakerThreshold(v *int) *AccountUpdate {
	if v != nil {
		_u.SetCircuitBreakerThreshold(*v)
	}
	return _u
}

// AddCircuitBreakerThreshold adds value to the "circuit_breaker_threshold" field.
func (_u *AccountUpdate) AddCircuitBreakerThreshold(v int) *AccountUpdate {
	_u.mutation.AddCircuitBreakerThreshold(v)
	return _u
}

// SetCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field.
func (_u *AccountUpdate) SetCircuitBreakerCooldownSeconds(v int) *AccountUpdate {
	_u.mutation.ResetCircuitBreakerCooldownSeconds()
	_u.mutation.SetCircuitBreakerCooldownSeconds(v)
	return _u
}

// SetNillableCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field if the given value is not nil.
func (_u *AccountUpdate) SetNillableCircuitBreakerCooldownSeconds(v *int) *AccountUpdate {
	if v != nil {
		_u.SetCircuitBreakerCooldownSeconds(*v)
	}
	return _u
}

// AddCircuitBreakerCooldownSeconds adds value to the "circuit_breaker_cooldown_seconds" field.
func (_u *AccountUpdate) AddCircuitBreakerCooldownSeconds(v int) *AccountUpdate {
	_u.mutation.AddCircuitBreakerCooldownSeconds(v)
	return _u
}
...
func (_u *AccountUpdate) check() error {
	...
	if v, ok := _u.mutation.CircuitBreakerThreshold(); ok {
	...
	if v, ok := _u.mutation.CircuitBreakerCooldownSeconds(); ok {
...
func (_u *AccountUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.CircuitBreakerThreshold(); ok {
		_spec.SetField(account.FieldCircuitBreakerThreshold, field.TypeInt, value)
	}
	if value, ok := _u.mutation.AddedCircuitBreakerThreshold(); ok {
		_spec.AddField(account.FieldCircuitBreakerThreshold, field.TypeInt, value)
	}
	if value, ok := _u.mutation.CircuitBreakerCooldownSeconds(); ok {
		_spec.SetField(account.FieldCircuitBreakerCooldownSeconds, field.TypeInt, value)
	}
	if value, ok := _u.mutation.AddedCircuitBreakerCooldownSeconds(); ok {
		_spec.AddField(account.FieldCircuitBreakerCooldownSeconds, field.TypeInt, value)
	}
...
// SetCircuitBreakerThreshold sets the "circuit_breaker_threshold" field.
func (_u *AccountUpdateOne) SetCircuitBreakerThreshold(v int) *AccountUpdateOne {
	_u.mutation.ResetCircuitBreakerThreshold()
	_u.mutation.SetCircuitBreakerThreshold(v)
	return _u
}
...
// SetNillableCircuitBreakerThreshold sets the "circuit_breaker_threshold" field if the given value is not nil.
func (_u *AccountUpdateOne) SetNillableCircuitBreakerThreshold(v *int) *AccountUpdateOne {
	if v != nil {
		_u.SetCircuitBreakerThreshold(*v)
	}
	return _u
...
// AddCircuitBreakerThreshold adds value to the "circuit_breaker_threshold" field.
func (_u *AccountUpdateOne) AddCircuitBreakerThreshold(v int) *AccountUpdateOne {
	_u.mutation.AddCircuitBreakerThreshold(v)
	return _u
}

// SetCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field.
func (_u *AccountUpdateOne) SetCircuitBreakerCooldownSeconds(v int) *AccountUpdateOne {
	_u.mutation.ResetCircuitBreakerCooldownSeconds()
	_u.mutation.SetCircuitBreakerCooldownSeconds(v)
	return _u
}
...
// SetNillableCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field if the given value is not nil.
func (_u *AccountUpdateOne) SetNillableCircuitBreakerCooldownSeconds(v *int) *AccountUpdateOne {
	if v != nil {
		_u.SetCircuitBreakerCooldownSeconds(*v)
	}
	return _u
...
// AddCircuitBreakerCooldownSeconds adds value to the "circuit_breaker_cooldown_seconds" field.
func (_u *AccountUpdateOne) AddCircuitBreakerCooldownSeconds(v int) *AccountUpdateOne {
	_u.mutation.AddCircuitBreakerCooldownSeconds(v)
	return _u
}
