...
func init() {
	...
	accountDescRpmLimit := accountFields[12].Descriptor()
	...
	// account.RpmLimitValidator is a validator for the "rpm_limit" field. It is called by the builders before save.
	account.RpmLimitValidator = accountDescRpmLimit.Validators[0].(func(int) error)
	// accountDescCircuitBreakerThreshold is the schema descriptor for circuit_breaker_threshold field.
	accountDescCircuitBreakerThreshold := accountFields[13].Descriptor()
	// account.DefaultCircuitBreakerThreshold holds the default value on creation for the circuit_breaker_threshold field.
	account.DefaultCircuitBreakerThreshold = accountDescCircuitBreakerThreshold.Default.(int)
	// account.CircuitBreakerThresholdValidator is a validator for the "circuit_breaker_threshold" field. It is called by the builders before save.
	account.CircuitBreakerThresholdValidator = accountDescCircuitBreakerThreshold.Validators[0].(func(int) error)
	// accountDescCircuitBreakerCooldownSeconds is the schema descriptor for circuit_breaker_cooldown_seconds field.
	accountDescCircuitBreakerCooldownSeconds := accountFields[14].Descriptor()
	// account.DefaultCircuitBreakerCooldownSeconds holds the default value on creation for the circuit_breaker_cooldown_seconds field.
	account.DefaultCircuitBreakerCooldownSeconds = accountDescCircuitBreakerCooldownSeconds.Default.(int)
	// account.CircuitBreakerCooldownSecondsValidator is a validator for the "circuit_breaker_cooldown_seconds" field. It is called by the builders before save.
	account.CircuitBreakerCooldownSecondsValidator = accountDescCircuitBreakerCooldownSeconds.Validators[0].(func(int) error)
	...
	// groupDescGithubCopilotOnly is the schema descriptor for github_copilot_only field.
	groupDescGithubCopilotOnly := groupFields[47].Descriptor()
	// group.DefaultGithubCopilotOnly holds the default value on creation for the github_copilot_only field.
	group.DefaultGithubCopilotOnly = groupDescGithubCopilotOnly.Default.(bool)
