...
// SetCircuitBreakerThreshold sets the "circuit_breaker_threshold" field.
func (_c *AccountCreate) SetCircuitBreakerThreshold(v int) *AccountCreate {
	_c.mutation.SetCircuitBreakerThreshold(v)
	return _c
}

// SetNillableCircuitBreakerThreshold sets the "circuit_breaker_threshold" field if the given value is not nil.
func (_c *AccountCreate) SetNillableCircuitBreakerThreshold(v *int) *AccountCreate {
	if v != nil {
		_c.SetCircuitBreakerThreshold(*v)
	}
	return _c
}

// SetCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field.
func (_c *AccountCreate) SetCircuitBreakerCooldownSeconds(v int) *AccountCreate {
	_c.mutation.SetCircuitBreakerCooldownSeconds(v)
	return _c
}

// SetNillableCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field if the given value is not nil.
func (_c *AccountCreate) SetNillableCircuitBreakerCooldownSeconds(v *int) *AccountCreate {
	if v != nil {
		_c.SetCircuitBreakerCooldownSeconds(*v)
	}
	return _c
}
...
func (_c *AccountCreate) defaults() error {
	...
	if _, ok := _c.mutation.CircuitBreakerThreshold(); !ok {
		v := account.DefaultCircuitBreakerThreshold
		_c.mutation.SetCircuitBreakerThreshold(v)
	}
	if _, ok := _c.mutation.CircuitBreakerCooldownSeconds(); !ok {
		v := account.DefaultCircuitBreakerCooldownSeconds
		_c.mutation.SetCircuitBreakerCooldownSeconds(v)
	}
...
func (_c *AccountCreate) check() error {
	...
	if v, ok := _c.mutation.RpmLimit(); ok {
		if err := account.RpmLimitValidator(v); err != nil {
			return &ValidationError{Name: "rpm_limit", err: fmt.Errorf(`ent: validator failed for field "Account.rpm_limit": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CircuitBreakerThreshold(); !ok {
		return &ValidationError{Name: "circuit_breaker_threshold", err: errors.New(`ent: missing required field "Account.circuit_breaker_threshold"`)}
	}
	if v, ok := _c.mutation.CircuitBreakerThreshold(); ok {
		if err := account.CircuitBreakerThresholdValidator(v); err != nil {
			return &ValidationError{Name: "circuit_breaker_threshold", err: fmt.Errorf(`ent: validator failed for field "Account.circuit_breaker_threshold": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CircuitBreakerCooldownSeconds(); !ok {
		return &ValidationError{Name: "circuit_breaker_cooldown_seconds", err: errors.New(`ent: missing required field "Account.circuit_breaker_cooldown_seconds"`)}
	}
	if v, ok := _c.mutation.CircuitBreakerCooldownSeconds(); ok {
		if err := account.CircuitBreakerCooldownSecondsValidator(v); err != nil {
			return &ValidationError{Name: "circuit_breaker_cooldown_seconds", err: fmt.Errorf(`ent: validator failed for field "Account.circuit_breaker_cooldown_seconds": %w`, err)}
		}
	}
	if _, ok := _c.mutation.RateMultiplier(); !ok {
...
func (_c *AccountCreate) createSpec() (*Account, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.CircuitBreakerThreshold(); ok {
		_spec.SetField(account.FieldCircuitBreakerThreshold, field.TypeInt, value)
		_node.CircuitBreakerThreshold = value
	}
	if value, ok := _c.mutation.CircuitBreakerCooldownSeconds(); ok {
		_spec.SetField(account.FieldCircuitBreakerCooldownSeconds, field.TypeInt, value)
		_node.CircuitBreakerCooldownSeconds = value
	}
...
// SetCircuitBreakerThreshold sets the "circuit_breaker_threshold" field.
func (u *AccountUpsert) SetCircuitBreakerThreshold(v int) *AccountUpsert {
	u.Set(account.FieldCircuitBreakerThreshold, v)
	return u
}

// UpdateCircuitBreakerThreshold sets the "circuit_breaker_threshold" field to the value that was provided on create.
func (u *AccountUpsert) UpdateCircuitBreakerThreshold() *AccountUpsert {
	u.SetExcluded(account.FieldCircuitBreakerThreshold)
	return u
}

// AddCircuitBreakerThreshold adds v to the "circuit_breaker_threshold" field.
func (u *AccountUpsert) AddCircuitBreakerThreshold(v int) *AccountUpsert {
	u.Add(account.FieldCircuitBreakerThreshold, v)
	return u
}

// SetCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field.
func (u *AccountUpsert) SetCircuitBreakerCooldownSeconds(v int) *AccountUpsert {
	u.Set(account.FieldCircuitBreakerCooldownSeconds, v)
	return u
}

// UpdateCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field to the value that was provided on create.
func (u *AccountUpsert) UpdateCircuitBreakerCooldownSeconds() *AccountUpsert {
	u.SetExcluded(account.FieldCircuitBreakerCooldownSeconds)
	return u
}

// AddCircuitBreakerCooldownSeconds adds v to the "circuit_breaker_cooldown_seconds" field.
func (u *AccountUpsert) AddCircuitBreakerCooldownSeconds(v int) *AccountUpsert {
	u.Add(account.FieldCircuitBreakerCooldownSeconds, v)
	return u
}
...
// SetCircuitBreakerThreshold sets the "circuit_breaker_threshold" field.
func (u *AccountUpsertOne) SetCircuitBreakerThreshold(v int) *AccountUpsertOne {
	return u.Update(func(s *AccountUpsert) {
		s.SetCircuitBreakerThreshold(v)
	})
}

// AddCircuitBreakerThreshold adds v to the "circuit_breaker_threshold" field.
func (u *AccountUpsertOne) AddCircuitBreakerThreshold(v int) *AccountUpsertOne {
	return u.Update(func(s *AccountUpsert) {
		s.AddCircuitBreakerThreshold(v)
	})
}

// UpdateCircuitBreakerThreshold sets the "circuit_breaker_threshold" field to the value that was provided on create.
func (u *AccountUpsertOne) UpdateCircuitBreakerThreshold() *AccountUpsertOne {
	return u.Update(func(s *AccountUpsert) {
		s.UpdateCircuitBreakerThreshold()
	})
}

// SetCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field.
func (u *AccountUpsertOne) SetCircuitBreakerCooldownSeconds(v int) *AccountUpsertOne {
	return u.Update(func(s *AccountUpsert) {
		s.SetCircuitBreakerCooldownSeconds(v)
	})
}

// AddCircuitBreakerCooldownSeconds adds v to the "circuit_breaker_cooldown_seconds" field.
func (u *AccountUpsertOne) AddCircuitBreakerCooldownSeconds(v int) *AccountUpsertOne {
	return u.Update(func(s *AccountUpsert) {
		s.AddCircuitBreakerCooldownSeconds(v)
	})
}

// UpdateCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field to the value that was provided on create.
func (u *AccountUpsertOne) UpdateCircuitBreakerCooldownSeconds() *AccountUpsertOne {
	return u.Update(func(s *AccountUpsert) {
		s.UpdateCircuitBreakerCooldownSeconds()
	})
}
...
// SetCircuitBreakerThreshold sets the "circuit_breaker_threshold" field.
func (u *AccountUpsertBulk) SetCircuitBreakerThreshold(v int) *AccountUpsertBulk {
	return u.Update(func(s *AccountUpsert) {
		s.SetCircuitBreakerThreshold(v)
	})
}
...
// AddCircuitBreakerThreshold adds v to the "circuit_breaker_threshold" field.
func (u *AccountUpsertBulk) AddCircuitBreakerThreshold(v int) *AccountUpsertBulk {
	return u.Update(func(s *AccountUpsert) {
		s.AddCircuitBreakerThreshold(v)
	})
}
...
// UpdateCircuitBreakerThreshold sets the "circuit_breaker_threshold" field to the value that was provided on create.
func (u *AccountUpsertBulk) UpdateCircuitBreakerThreshold() *AccountUpsertBulk {
	return u.Update(func(s *AccountUpsert) {
		s.UpdateCircuitBreakerThreshold()
	})
}
...
// SetCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field.
func (u *AccountUpsertBulk) SetCircuitBreakerCooldownSeconds(v int) *AccountUpsertBulk {
	return u.Update(func(s *AccountUpsert) {
		s.SetCircuitBreakerCooldownSeconds(v)
	})
}
...
// AddCircuitBreakerCooldownSeconds adds v to the "circuit_breaker_cooldown_seconds" field.
func (u *AccountUpsertBulk) AddCircuitBreakerCooldownSeconds(v int) *AccountUpsertBulk {
	return u.Update(func(s *AccountUpsert) {
		s.AddCircuitBreakerCooldownSeconds(v)
	})
}
...
// UpdateCircuitBreakerCooldownSeconds sets the "circuit_breaker_cooldown_seconds" field to the value that was provided on create.
func (u *AccountUpsertBulk) UpdateCircuitBreakerCooldownSeconds() *AccountUpsertBulk {
	return u.Update(func(s *AccountUpsert) {
		s.UpdateCircuitBreakerCooldownSeconds()
	})
}
